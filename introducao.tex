...
A tomada de decisões envolve, por exemplo, avaliar quando e como uma empresa deve pensar em expandir seu negócio - um projeto como esse, se mal planejado, pode levar uma organização a sofrer enormes prejuizos. Segundo \citeonline{Mangini2014}, a tomada de decisão em termos de localização não pode ser feita de maneira aleatória e subjetiva, mas embasada em um método ou ferramenta que permita
