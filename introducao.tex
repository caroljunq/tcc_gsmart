...
Neste trabalho, o foco do \emph{geomarketing} é voltado à exploração do tráfego
de pessoas através da criação do GSmart - uma ferramenta acessível, aliada às redes de
Internet sem fio e dispositivos móveis para captura do tráfego de pessoas em
