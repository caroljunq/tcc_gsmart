...
\titulo{Aplicando geomarketing na medição do tráfego de pessoas através de redes sem fio}
...
\ifresumo
	...
	\begin{resumo}
			...
			desenvolver um sistema que mede o tráfego de pessoas em determinadas zonas através da rede Wi-Fi e dispositivos móveis. Além disso,
			pretende-se identificar o perfil desses indivíduos de acordo com o aparelho móvel que utilizam.
