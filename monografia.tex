...
\ifresumo
	...
	\begin{resumo}
			Hoje, num mundo plenamente informatizado e conectado, a importância da informação é inestimável, sobretudo nos negócios: decisões sobre como e onde escolher o melhor ponto para estabelecer uma loja tornaram-se complexas, dada a quantidade de variáveis a serem consideradas ao avaliar-se tal questão. Conceitos tradicionais em marketing e administração, sozinhos, já não mais são suficientes para realizar-se essa tarefa. 
			Nesse contexto, a crescente necessidade em otimização dos processos empresariais encontrou na computação seu melhor aliado: tecnologias em hardware e software tornam-se de enorme auxílio, permitindo a coleta de dados para análise com maior rapidez e eficiência. Origina-se, assim, o \emph{geomarketing}, um conjunto de conhecimentos em geolocalização, administração e marketing, hoje fundamental no planejamento estratégico de empresas. 
			Entretanto, o acesso aos benefícios deste serviço ainda restringe-se a grandes e médias organizações, ou então é oferecido por grandes consultoras especializadas. Pequenos empreendedores ou mesmo estudantes da área de tecnologia e administração raramente conhecem ou tem oportunidade de aplicar/ pesquisar conceitos de \emph{geomarketing} em sua rotina, já que quase não há ferramentas gratuitas disponíveis no mercado para essa finalidade. 
			Baseando-se nesta realidade, o presente trabalho tem como proposta desenvolver um sistema para coletar e aferir o tráfego de pessoas, em determinadas zonas, utilizando-se de redes Wi-Fi e dispositivos móveis, tecnologias estas relativamente baratas e ao alcance a qualquer pessoa.
