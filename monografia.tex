...
Agradecemos a todos os familiares e, principalmente, aos nossos pais por todo
incentivo e apoio incondicional, sem os quais jamais conseguiríamos finalizar
essa etapa de nossas vidas.

À UNESP, pela oportunidade conferida a nós de realizar o curso de Sistemas de
Informação e ao excelente ambiente propiciado.

A todos os nossos professores, pela orientação, conhecimento e experiência
compartilhados conosco.

Ao nosso orientador, Prof. Dr. Sidnei Bergamaschi, por aceitar nos auxiliar na
elaboração deste trabalho, além de todas as ideias, sugestões e correções;

Ao nosso coordenador de curso, Prof. Remo, pelo paciente trabalho de revisão e
orientação aos formandos deste ano.

Aos amigos, sempre presentes, por toda a motivação e suporte.

A Luís Puhl de Souza, Vinicius Figueiredo e Deivison Santana
por toda paciência, tempo e ajuda quando necessário.

Aos colegas e companheiros de classe, com os quais compartilhamos tantos
momentos nesses semestres.

Ao LTIA e ao Prof. Morgado pelas experiências, lições de vida e oportunidades durante todos esses anos.
