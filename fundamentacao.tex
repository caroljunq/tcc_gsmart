...
sem fio ocorreu também devido sua grande área de cobertura, pois o tema de indicar pessoas
...
incluem roteadores e servidores, mas se esquecem dos principais roteadores: as pessoas. Estas têm tempo, atenção e precisão limitadas, então
não são muito boas em capturar dados sobre coisas do mundo real. Segundo ele, se nosso mundo é feito por coisas, então por quê não dar a capacidade
...
Este trabalho utiliza o conceito de IoT na escolha de dispositivos móveis como meio de reconhecimento e fonte de informação de pessoas.
...
\subsection{Dispositivos móveis como ``coisas''}
...
todo o mundo, considera-se esse equipamento de uso comum. Além disso, esses equipamentos móveis fornecem informação pública passiva
através da rede Wi-Fi e independem da fabricante para serem detectados numa rede. Portanto, dispositivos móveis serão utilizados como meio
